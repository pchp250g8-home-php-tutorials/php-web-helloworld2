...
Приложение (веб сайт) состоит из трёх HTML страниц с именами файлов "form-get.html" и "form-post.html" и скрипта на языке программирования PHP с именем файла "HelloWorld2.php".
